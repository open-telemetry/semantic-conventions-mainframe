...
| Role | Key | Stability | [Requirement Level](https://opentelemetry.io/docs/specs/semconv/general/attribute-requirement-level/) | Value Type | Description | Example Values |
| --- | --- | --- | --- | --- | --- | --- |
| Identity | [`mainframe.partition.name`](/docs/registry/mainframe/README.md#mainframe-partition-name) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | The name of the logical partition (LPAR) running on the mainframe. [10] | `LPAR01`; `PRODZ`; `TEST1` |
| Description | [`host.name`](/docs/registry/host/README.md#host-name) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | Name of the host. On Unix systems, it may contain what the hostname command returns, or the fully qualified hostname, or another name specified by the user. [11] | `opentelemetry-test` |

**[10] `mainframe.partition.name`:** A logical partition (LPAR) is the mainframe equivalent of a virtual machine (VM) in distributed cloud environments. Each LPAR can run an independent operating system such as z/OS, Linux, or z/VM. Reported by the HMC Web Services API partition object field `name`.

**[11] `host.name`:** The name of the Central Processing Complex (CPC) that hosts this logical partition (LPAR). Reported by the HMC Web Services API partition object field `parent-object-uri`.
...
| Role | Key | Stability | [Requirement Level](https://opentelemetry.io/docs/specs/semconv/general/attribute-requirement-level/) | Value Type | Description | Example Values |
| --- | --- | --- | --- | --- | --- | --- |
| Identity | [`mainframe.partition.name`](/docs/registry/mainframe/README.md#mainframe-partition-name) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | The name of the logical partition (LPAR) running on the mainframe. [12] | `LPAR01`; `PRODZ`; `TEST1` |
| Identity | [`mainframe.partition.nic.name`](/docs/registry/mainframe/README.md#mainframe-partition-nic-name) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | The name of the virtual network interface card (NIC) attached to a logical partition (LPAR) in Dynamic Partition Manager (DPM) mode. [13] | `nic-0`; `nic-mgmt`; `nic-prod` |
| Description | [`host.name`](/docs/registry/host/README.md#host-name) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | Name of the host. On Unix systems, it may contain what the hostname command returns, or the fully qualified hostname, or another name specified by the user. [14] | `opentelemetry-test` |
| Description | [`mainframe.adapter.name`](/docs/registry/mainframe/README.md#mainframe-adapter-name) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | The name of the I/O adapter in the form CSS.Chpid. [15] | `0.00`; `0.2D`; `1.E3` |
| Description | [`mainframe.adapter.port.id`](/docs/registry/mainframe/README.md#mainframe-adapter-port-id) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | The identifier of the physical port on a mainframe network adapter. [16] | `0`; `1` |

**[12] `mainframe.partition.name`:** The name of the DPM partition that owns this NIC.

**[13] `mainframe.partition.nic.name`:** Reported by the HMC Web Services API partition-attached-network-interface metric group. In distributed systems terms, this is analogous to a virtual NIC (vNIC) attached to a virtual machine.

**[14] `host.name`:** The name of the Central Processing Complex (CPC) that hosts the partition owning this NIC.

**[15] `mainframe.adapter.name`:** The name of the physical adapter backing this virtual NIC.

**[16] `mainframe.adapter.port.id`:** The port ID on the physical adapter backing this virtual NIC.
...
| Role | Key | Stability | [Requirement Level](https://opentelemetry.io/docs/specs/semconv/general/attribute-requirement-level/) | Value Type | Description | Example Values |
| --- | --- | --- | --- | --- | --- | --- |
| Identity | [`mainframe.storage.group.name`](/docs/registry/mainframe/README.md#mainframe-storage-group-name) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | The name of the DPM storage group attached to the Central Processing Complex (CPC). [17] | `sg-fcp-prod`; `sg-nvme-test` |
| Description | [`mainframe.storage.group.type`](/docs/registry/mainframe/README.md#mainframe-storage-group-type) | ![Development](https://img.shields.io/badge/-development-blue) | `Required` | string | The connectivity type of the DPM storage group. [18] | `fcp`; `fc`; `nvme` |
| Description | [`host.name`](/docs/registry/host/README.md#host-name) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | Name of the host. On Unix systems, it may contain what the hostname command returns, or the fully qualified hostname, or another name specified by the user. [19] | `opentelemetry-test` |
...
**[19] `host.name`:** The name of the Central Processing Complex (CPC) that owns this storage group.
...
| Role | Key | Stability | [Requirement Level](https://opentelemetry.io/docs/specs/semconv/general/attribute-requirement-level/) | Value Type | Description | Example Values |
| --- | --- | --- | --- | --- | --- | --- |
| Identity | [`mainframe.storage.group.name`](/docs/registry/mainframe/README.md#mainframe-storage-group-name) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | The name of the DPM storage group attached to the Central Processing Complex (CPC). [20] | `sg-fcp-prod`; `sg-nvme-test` |
| Identity | [`mainframe.storage.group.volume.name`](/docs/registry/mainframe/README.md#mainframe-storage-group-volume-name) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | The name of the DPM storage volume within a storage group. [21] | `vol-boot-0`; `vol-data-1` |
| Description | [`host.name`](/docs/registry/host/README.md#host-name) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | Name of the host. On Unix systems, it may contain what the hostname command returns, or the fully qualified hostname, or another name specified by the user. [22] | `opentelemetry-test` |

**[20] `mainframe.storage.group.name`:** The name of the storage group that contains this volume.

**[21] `mainframe.storage.group.volume.name`:** Reported by the HMC Web Services API storage-volume resource object field `name` (DPM mode only, HMC ≥ 2.14.1). A storage volume is a single logical unit of block storage (LUN / ECKD DASD cylinder set / NVMe namespace) within a storage group.

**[22] `host.name`:** The name of the Central Processing Complex (CPC) that owns the storage group containing this volume.
